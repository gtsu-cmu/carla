...
def main():
    ...
    try:
        ...
        # at random.
        bp = blueprint_library.find('vehicle.tesla.model3')#random.choice(blueprint_library.filter('vehicle'))
        ...
        lidar_location = carla.Location(0,0,1.83)
        lidar_rotation = carla.Rotation(0,0,0)
        lidar_transform = carla.Transform(lidar_location,lidar_rotation)
        lidar = world.spawn_actor(lidar_bp,lidar_transform,attach_to=vehicle)
        actor_list.append(lidar)
        lidar.listen(lambda lidar: lidar.save_to_disk('_out/%06d.txt' % lidar.frame))
